...
项目根目录包含 `KIMI-WORK-HANDOFF.md`，这是一份专为 **Kimi Work** 编写的传递文档。当你需要 AI 助手协助配置、部署或维护本项目时，直接将此文档发送给 Kimi Work 即可，它会按照文档中的逐步指令完成操作。

**文档包含：**
- 完整的服务器部署流程（Nginx + PM2 + SSL）
- 日常数据维护脚本说明（训练安排 / 最新资讯 / 批量数据导入）
- 常见问题排查指南
- 可直接复制使用的 Kimi Work 指令模板
